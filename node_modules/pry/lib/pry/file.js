(function() {
  ...
  File = (function() {
    function File(name, line1) {
      var i, j, l, len, lines, ref;
      this.name = name;
      this.line = line1;
      this.line = parseInt(this.line);
      lines = this.content().split("\n");
      if (((ref = lines[this.line]) != null ? ref.match(/eval +pry\.it/) : void 0) == null) {
        for (i = j = 0, len = lines.length; j < len; i = ++j) {
          l = lines[i];
          if (l.match(/eval +pry\.it/) != null) {
            this.line = i + 1;
            break;
          }
        }
    ...
    File.prototype.getLocalVariables = function() {
      var _, currentIndentLevel, i, indentLevel, j, k, len, line, lines, localVar, match, multiple, ref, ref1, single, vars;
      lines = this.content().split("\n");
      currentIndentLevel = this._getIndentLevel(lines[this.line - 1]);
      vars = [];
